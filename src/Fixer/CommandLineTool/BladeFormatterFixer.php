 ...
 */
final class BladeFormatterFixer extends AbstractCommandLineToolFixer implements DependencyCommandContract, DependencyNameContract
{
    use DependencyName;
    ...
    public function dependencyCommand(): string
    {
        switch (\PHP_OS_FAMILY) {
            ...
            case 'Linux':
            default:
                return 'npm install -g blade-formatter';
        }
    }
