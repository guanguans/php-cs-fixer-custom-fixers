...
/**
 * @extends AbstractFixerTestCase<\Guanguans\PhpCsFixerCustomFixers\Fixer\CommandLineTool\SqlfluffFixer>
 *
 * @internal
 */
final class SqlfluffFixerTest extends AbstractFixerTestCase
{
    /**
