...
/**
 * @extends AbstractFixerTestCase<\Guanguans\PhpCsFixerCustomFixers\Fixer\CommandLineTool\TyposFixer>
 *
 * @internal
 */
final class TyposFixerTest extends AbstractFixerTestCase
{
    /**
