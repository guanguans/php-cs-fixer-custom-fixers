...
/**
 * @extends AbstractFixerTestCase<\Guanguans\PhpCsFixerCustomFixers\Fixer\CommandLineTool\MarkdownlintCli2Fixer>
 *
 * @internal
 */
final class MarkdownlintCli2FixerTest extends AbstractFixerTestCase
{
    /**
